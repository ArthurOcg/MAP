...
class Parameterized  { 
    ...
    public static void main(String []args) {
        ...
        Parameterized.CarFactory hyndai = new Parameterized.Hyundai();
        System.out.println("Hyundai factory creates " + hyndai.createCar(Type.HATCH).showInfo());
        System.out.println("Hyndai factory creates " + hyndai.createCar(Type.SEDAN).showInfo());
